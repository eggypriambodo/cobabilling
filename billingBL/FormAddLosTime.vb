...
Public Class FormAddLosTime
    ...
    Sub tambahPaket()
        ...
        Try
            connect()
            CMD = New MySqlCommand("INSERT INTO tb_daftarpaket (nama_paket, jenis_paket, harga_siang, harga_malam, akhir_siang, akhir_malam, disc_table) VALUES (@nama_paket, 'LOSTIME', @harga_siang, @harga_malam, @akhir_siang, @akhir_malam, @disc_table)", Koneksi)
    ...
    Private Sub FormAddLosTime_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadJamAkhirMalam()
        loadJamAkhirSiang()
        tampilpaket()
    End Sub
