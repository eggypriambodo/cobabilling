...
Partial Class FormDetailTable
    ...
    Private Sub InitializeComponent()
        ...
        Label2.TabIndex = 1
        Label2.Text = "Jl. Terusan Danau Kerinci Jl. Sawojajar II No.1E-23, Keduyo, Mangliawan, Kec. Pakis, Kabupaten Malang, Jawa Timur 65154"
        ...
        Label1.TabIndex = 0
        Label1.Text = "TRIPLE F POOL N COFFEE"
        ...
        Label55.Location = New Point(3, 105)
        Label55.Name = "Label55"
        Label55.Size = New Size(109, 35)
        Label55.TabIndex = 15
        Label55.Text = "PPn 10%"
        ...
        labelPPn.Location = New Point(238, 105)
        labelPPn.Name = "labelPPn"
        labelPPn.Size = New Size(21, 35)
